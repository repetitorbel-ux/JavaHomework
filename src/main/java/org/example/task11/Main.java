...
//        System.out.println();
        ...
        Robot[] exhibition2 = {robotBuilder1, robotDeminer1};

        //1.6.3 Создание выставки 3 (саперы)
        Robot[] exhibition3 = {robotDeminer1};
        ...
        //1.6.5 Демонстрация дополнительных способностей роботов-строителей с выставки 2
